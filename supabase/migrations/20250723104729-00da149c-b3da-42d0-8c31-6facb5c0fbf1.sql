...
-- Create mock data for sales returns
...
-- Return from XYZ Infrastructure
('SR-2025-002', 
...
-- Return from Global Engineering
('SR-2025-003', 
...
-- Return from Metro Steel Corp
('SR-2025-004', 
 (SELECT id FROM customers WHERE name = 'Metro Steel Corporation' LIMIT 1),
...
-- Return from Precision Tools
('SR-2025-005', 
 (SELECT id FROM customers WHERE name = 'Precision Tools Ltd.' LIMIT 1),
...
-- Create receivables from unpaid invoices
